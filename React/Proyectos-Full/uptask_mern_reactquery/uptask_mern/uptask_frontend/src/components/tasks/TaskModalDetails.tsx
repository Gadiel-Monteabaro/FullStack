                ...
                >
                  <DialogPanel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all p-12">
                    ...
                    {data.completeBy.length ? (
                      <>
                        <p className="font-bold text-xl text-slate-600 my-5">
                    ...
                    <div className="my-5 space-y-3">
                      ...
                      <select
                        className="w-full p-2 bg-white border border-gray-300 rounded focus:outline-none focus:bg-white focus:border-t-fuchsia-700 border-t-2 leading-tigh"
