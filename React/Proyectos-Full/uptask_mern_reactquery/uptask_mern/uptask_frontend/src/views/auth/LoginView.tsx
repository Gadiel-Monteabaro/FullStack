  ...
  return (
    <>
      ...
      <form
        ...
        className="space-y-8 p-7 mt-5 rounded-md bg-white"
        noValidate
      >
        ...
        <input
          ...
          className="bg-fuchsia-600 hover:bg-fuchsia-700 w-full p-2 rounded-md  text-white font-black  text-xl cursor-pointer"
        />
      </form>
